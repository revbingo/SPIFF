...
//		
//		assertEquals(Bitmap.class, bindings.get("BITMAPFILE").getType());
//		assertEquals(BitmapFileHeader.class, bindings.get("BITMAPFILEHEADER").getType());
//		assertEquals(BitmapInfoHeader.class, bindings.get("BITMAPINFOHEADER").getType());
//		assertEquals(PixelData.class, bindings.get("PIXELDATA").getType());
