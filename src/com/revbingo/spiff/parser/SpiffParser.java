/* Generated By:JJTree&JavaCC: Do not edit this line. SpiffParser.java */
...
public class SpiffParser implements/*@bgen(jjtree)*/ SpiffParserTreeConstants,InstructionParser, SpiffParserConstants {/*@bgen(jjtree)*/
  protected JJTSpiffParserState jjtree = new JJTSpiffParserState();private List <Instruction> instructions = new ArrayList <Instruction> ();
  ...
  final public List<Instruction> parse() throws ParseException {
                             /*@bgen(jjtree) parse */
 ...
 /*@bgen(jjtree) datatypeDefs */
  ...
  boolean jjtc000 = true;
  jjtree.openNodeScope(jjtn000);Token id, clazz;
    try {
      label_2:
      while (true) {
        switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
 ...
 /*@bgen(jjtree) fixedString */
  ...
  boolean jjtc000 = true;
  jjtree.openNodeScope(jjtn000);Token t4, t5;
  String s;
    try {
 ...
 /*@bgen(jjtree) literalString */
   ...
   boolean jjtc000 = true;
   jjtree.openNodeScope(jjtn000);Token t1, t4, t5;
    try {
      jj_consume_token(TY_STRING);
        String encoding = defaultEncoding;
      jj_consume_token(OPEN_PAR);
 ...
 /*@bgen(jjtree) terminatedString */
  ...
  boolean jjtc000 = true;
  jjtree.openNodeScope(jjtn000);Token t2, t3;
    try {
        String encoding = defaultEncoding;
      jj_consume_token(TY_STRING);
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
 ...
 /*@bgen(jjtree) fixedNumber */
  ...
  boolean jjtc000 = true;
  jjtree.openNodeScope(jjtn000);Token t2, t4;
    try {
      t2 = numberType();
      t4 = jj_consume_token(IDENTIFIER);
    jjtree.closeNodeScope(jjtn000, true);
 ...
 /*@bgen(jjtree) unsignedNumberType */
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x10000,0x0,0xfc01fff8,0xfc00fff8,0xfc00fff8,0x0,0xc000,0xfc000000,0x10000,0x10000,0x1000000,0x1000000,0x100000,0x0,0x0,0x0,0x0,0x100000,0x1000000,0x100000,0x0,0x3f0,0x3c00,};
   }
   private static void jj_la1_init_1() {
      jj_la1_1 = new int[] {0x0,0x80,0x11007b,0x1007b,0x1007b,0x100000,0x10000,0x7b,0x0,0x0,0x0,0x0,0x0,0x3f00,0x3f00,0x4000,0x8000,0xcb0000,0x0,0xeb0000,0xab0000,0x0,0x0,};
   }
